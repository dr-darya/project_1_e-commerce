...
Python с использованием Jupyter Notebook.

____
**Анализ совершенных покупок. Ответить на следующие вопросы:**
...
**Для решения задачи нужно провести предварительное исследование данных и сформулировать, что должно считаться покупкой.**
...
# Реализация проекта
1. Провела EDA
2. Проанализировала поведение пользователей, сформулировала, что считается покупкой
3. Провела когортный анализ
4. Построила RFM-сегментацию пользователей.
